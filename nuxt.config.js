  ...
  */
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'msapplication-TileImage', content: '/favicons/ms-icon.png' },
      // PWA primary color
    ...
    link: [
      ...
      { rel: 'apple-touch-icon', sizes: '57x57', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '60x60', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '72x72', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '76x76', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '114x114', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '120x120', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '144x144', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '152x152', href: '/favicons/ms-icon.png' },
      { rel: 'apple-touch-icon', sizes: '180x180', href: '/favicons/ms-icon.png' },
      { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/favicons/ms-icon.png' },
      { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/favicons/ms-icon.png' },
      { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/favicons/ms-icon.png' },
      { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/favicons/ms-icon.png' },
